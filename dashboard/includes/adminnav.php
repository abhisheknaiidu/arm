...
.navbar {
 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index">A-R-M</a>
            </div>
            
            <ul class="nav navbar-right top-nav">
                <?php if($_SESSION['role'] !== 'ARM') { ?>  <?php } ?>
                <li class="dropdown">
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php if($_SESSION['role'] == 'ARM') {
                   ...
                   <li>
                    ...
                    <li>
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="collapse" data-target="#posts"><i class="fa fa-fw fa-file-text"></i> Account <i class="fa fa-fw fa-caret-down"></i></a>
                    ...
                    <li>
                         <a href="javascript:;" data-toggle="collapse" data-target="#user"><i class="fa fa-fw fa-users"></i> Documents <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./notes.php">View All Documents</a>
                            </li>
                            <li>
